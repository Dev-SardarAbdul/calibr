...
import {
  ShopAddProductModal,
  ShopDeletProductModal,
  ShopEditProductModal,
} from "../../../components";
  ...
  return (
    <div>
      <div className="w-full mx-auto lg:w-3/4">
        ...
        <AnimatePresence>
          {showAddModal && (
            <ShopAddProductModal setShowAddModal={setShowAddModal} />
          )}
        </AnimatePresence>
        <AnimatePresence>
          {showEditModal && (
            <ShopEditProductModal setShowEditModal={setShowEditModal} />
          )}
        </AnimatePresence>
        <AnimatePresence>
          {showDeleteModal && (
            <ShopDeletProductModal setShowDeleteModal={setShowDeleteModal} />
          )}
        </AnimatePresence>
      </div>
    </div>
